      ...
      children: <Widget>[
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text('Exclusive Hotels', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22.0)),
              GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Text(hotel.name, style: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w600)),
                                SizedBox(height: 2.0),
