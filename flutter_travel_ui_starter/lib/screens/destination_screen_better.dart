...
class DestinationScreenB extends StatefulWidget {
  final Destination destination;

  DestinationScreenB({this.destination});

  @override
  _DestinationScreenBState createState() => _DestinationScreenBState();
}

class _DestinationScreenBState extends State<DestinationScreenB> {
  @override
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Text(widget.destination.city, style: TextStyle(color: Colors.white, fontSize: 22.0, fontWeight: FontWeight.w600)),
